...
%Applied Load
Mass_Person = 90*9.8;%Multiplied by 
Load_Mag = 135*9.8;
F = [0,-Load_Mag,0];
F_Reaction=[0,(Load_Mag+Mass_Person),0];
F_COM=[0,-((Mass_Person*0.634)),0]; %Mass of the torso that is exerted from the centroid
...
for Ankle_A = 55:89.5 
   for Knee_A = 55:89.5
       for Hip_A = 55:89.5
        ...
        %Position of Joints and important points
        ...
        %Distance vector from joints to centroid
